<template>
  <div>
    ...
    <div>
      ...
      <div class="brand" v-for="item in brandList1" :key="item.eventId">
    ...
    <div>
      ...
      <div class="brand" v-for="item in brandList2" :key="item.eventId">
        <div :style=" {backgroundImage:'url('+item.imageUrl+')'} "
          style="height:207px; background-size:100% 100%;" class="context"
        >
          <div class="shade">
...
export default {
  ...
  mounted () {
    ...
    axios.get('http://www.mei.com/appapi/home/eventForH5?params=%7B%7D&timestamp=1602164276537&summary=d10708042bebc27bfc952924645d38c2&platform_code=H5').then(res => {
