...
export default {
  ...
  mounted () {
    http('/home/mktBannerApp/v3?silo_id=2013000100000000008&platform_code=PLATEFORM_H5').then(res => {
      this.imgList = res.data.banners
    })

    http('/home/eventForH5?params=%7B%7D&timestamp=1602164276537&summary=d10708042bebc27bfc952924645d38c2&platform_code=H5').then(res => {
      // console.log(res.data.lists[1].events)
      this.brandList1 = res.data.lists[0].events
      this.brandList2 = res.data.lists[1].events
    })
  }
}
</script>
